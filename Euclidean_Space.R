...
EuclideanSpace <- setRefClass("EuclideanSpace",
                              ...
                              methods = list(
                                ...
                                random_uniform <- function(self, n_samples = 1){
                                  #Sample in the Euclidean space with the uniform distribution.
...
EuclideanMetric <- setRefClass("EuclideanMetric",
                               ...
                               methods = list(
                                 ...
                                 inner_product_matrix <- function(self, base_point=None){
                                   # Inner product matrix, independent of the base point.
                                 ...
                                 # NOTE exp is a base function in r.  I will rename the function
                                 ...
                                 # NOTE mean is a base function in r.  I will rename the function
